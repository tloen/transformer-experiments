"""
The following code was adapted from Karpathy's.

The main difference is that we allow the component module definitions
to be overwritten easily. This is useful for benchmarking different
...
class BaseGPT(nn.Module):
    ...
    def _init_weights(self, module):
        if isinstance(module, self.linear_class):
            ...
            torch.nn.init.normal_(module.weight, mean=0.0, std=0.02)
        elif isinstance(module, (BaseLayerNorm, nn.LayerNorm)):
